    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'py-3 bg-dark-950/80 backdrop-blur-xl border-b border-white/[0.04]' : 'py-5 bg-transparent'}`}>
            <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
                ...
                <Link to="/" className="px-5 py-2.5 rounded-lg text-sm font-semibold bg-white/[0.04] border border-white/[0.08] text-text-primary transition-all duration-300 hover:bg-white/[0.08] hover:border-white/[0.16] hover:-translate-y-0.5">
                    Back to Portfolio
                </Link>
            </div>
        </nav>
